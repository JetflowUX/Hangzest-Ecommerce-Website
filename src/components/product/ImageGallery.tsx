  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <h2 className="font-display text-3xl sm:text-5xl text-white transform -rotate-12 tracking-widest relative z-10">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {images.map((img, idx) => (
          ...
          >
            <div className="absolute inset-0 bg-noise opacity-30 mix-blend-overlay"></div>
            <span className="font-display text-sm sm:text-xs text-white tracking-wider z-10">
              {img.text.split(" ")[0]}
            </span>
          </button>
        ))}
